...
//Pre-load
var imgWait = new Image(27,24); 
imgWait.src = "res/images/waitp.gif";
var imgWaitStop = new Image(27,24); 
imgWaitStop.src = "res/images/waitstop.png";
...
function yTextEdit(t_id, ref_id){
    ...
    var txSave = (function() {
        $Id(t_id).value=myEditor.saveHTML();
    });

    //myEditor.addListener('afterNodeChange', txeditorHandler);
    myEditor.addListener('editorWindowBlur', txSave);
